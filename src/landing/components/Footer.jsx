...
const Footer = () => {
  return(
    <>
        <div className="foot_main lg:px-12   overflow-hidden">
            <a href="" className='  flex absolute underline  '><p>Question ? Contact us.</p></a>
             
            <div className="foot_div1 relative   ">
                <ul className ="foot_ul1">
                    <li className ="content_li underline"><a className="links" href="https://help.netflix.com/en/node/412">FAQ</a></li>
                    <li className ="content_li underline"><a  className="links" href="http://ir.netflix.com/">
...
// https://rootritesh.medium.com/netflix-originals-clone-using-react-js-for-beginners-b2970c4532d
