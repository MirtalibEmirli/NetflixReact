    ...
    visibleMovie && (
      ...
      >
        <div className="ml-[64px] -mt-10  ">
          ...
          <h2 className="text-4xl mt-[5px] ml-[45px] font-Libre">
            {visibleMovie.title}
          </h2>
          ...
          <div className="flex gap-3 mt-3">
            ...
            <button
              onClick={() => {navigate("/details",{ state: { id: visibleMovie.id,type:visibleMovie.media_type}} )}}
              className="hover:bg-zinc-500 duration-200 transition ease-in
    flex h-[40px] w-[200px] gap-3 items-center rounded-[4px] px-6   font-bold bg-[#515451] text-white"
            >
              <img src={info} alt="" className="h-[23px] " />
              More Info
            </button>
          </div>
        </div>
